            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Liste des Partisans</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Partisans</li>
                            </ol>
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="{{ route('admin-export-members') }}">
                                    <button type="button" class="btn btn-success waves-effect waves-light mb-2 me-2"><i
                                            class="mdi mdi-download me-1"></i> Exporter</button>
                                </a>
                            </div>
                        </div><!-- end col-->
                    </div>
    ...
    <div class="modal fade" id="cardModalCenter" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Êtes-vous sûr de vouloir supprimer ce partisan ?
                </div>
                <div class="modal-footer">
