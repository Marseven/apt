            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Liste des élections</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Élections</li>
                            </ol>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabelOne">Ajouter une élection</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin-create-election') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="date_election" required>
                        </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#datatable-buttons').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin-ajax-elections') }}",
                columns: [{
                        data: 'id'
                    },
                    {
